...
return  array(
    ...
    /*
    'THINK_EMAIL' => array(
        'SMTP_HOST'   => 'smtp.hyitravel.com', //SMTP服务器
        'SMTP_PORT'   => '25', //SMTP服务器端口
        'SMTP_USER'   => 'customer_serivce@hyitravel.com', //SMTP服务器用户名
        'SMTP_PASS'   => 'zads1118', //SMTP服务器密码
        'FROM_EMAIL'  => 'customer_serivce@hyitravel.com', //发件人EMAIL
        'FROM_NAME'   => '系统管理员', //发件人名称
    ...
    'THINK_EMAIL' => array(
        ...
        'SMTP_PORT'   => '25', //SMTP服务器端口
        'SMTP_USER'   => 'info.investamerica@top-eb5.com', //SMTP服务器用户名
        'SMTP_PASS'   => '123456abc', //SMTP服务器密码
        'FROM_EMAIL'  => 'info.investamerica@top-eb5.com', //发件人EMAIL
        'FROM_NAME'   => '系统管理员', //发件人名称
        'REPLY_EMAIL' => '', //回复EMAIL（留空则为发件人EMAIL）
        'REPLY_NAME'  => '', //回复名称（留空则为发件人名称）
    ),
    ...
    */
    ...
    'THINK_EMAIL' => array(
        ...
        'SMTP_PORT'   => '25', //SMTP服务器端口
        'SMTP_USER'   => 'irunner', //SMTP服务器用户名
        'SMTP_PASS'   => '4ZWaYdPZgh10ulLb', //SMTP服务器密码
        'FROM_EMAIL'  => 'irunner@paobuqu.cn', //发件人EMAIL
        'FROM_NAME'   => '系统管理员', //发件人名称
        'REPLY_EMAIL' => '', //回复EMAIL（留空则为发件人EMAIL）
        'REPLY_NAME'  => '', //回复名称（留空则为发件人名称）
    ),
    */
    'THINK_EMAIL' => array(
        ...
        'SMTP_USER'   => 'irunner', //SMTP服务器用户名
        'SMTP_PASS'   => '4ZWaYdPZgh10ulLb', //SMTP服务器密码
        'FROM_EMAIL'  => 'chengdu@tengtidu.com', //发件人EMAIL
        'FROM_NAME'   => '成都国际马拉松赛组委会', //发件人名称
        'REPLY_EMAIL' => '', //回复EMAIL（留空则为发件人EMAIL）
        'REPLY_NAME'  => '', //回复名称（留空则为发件人名称）
    ),
