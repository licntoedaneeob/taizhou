...
defined('TEAM_LISTINFO_UPLOAD') or define('TEAM_LISTINFO_UPLOAD', ROOT_PATH.'/public/team_listinfo' );     //团队报名信息表上传  最终路径
defined('TEAM_LISTINFO_UPLOAD_URI') or define('TEAM_LISTINFO_UPLOAD_URI', '/public/team_listinfo' );     //团队报名信息表上传  相对路径
...
$array = array( 	
    ...
    'DEFAULT_ACTION'        => 'index', // 默认操作名称  index  welcome
