...
class homeAction extends TAction
{
	...
	public function get_openid($goto=""){
    	...
    	if(isset($_SESSION['WX_INFO']['openid']) && $_SESSION['WX_INFO']['openid']!=""){
			...
			if( (isset($_REQUEST['debug']) && $_REQUEST['debug']==1) || ($_SERVER["HTTP_HOST"]=='doukadali.loc') ){
				//调试html、css的模式
	        }
	        else{
	...
	//记录开始游戏  http://doukadali.loc/cms/home/douka_dali_game1start
	...
	//记录结束游戏（提交个人信息就算结束）  http://doukadali.loc/cms/home/douka_dali_game1end
	...
	//上传原始头像 提交  http://doukadali.loc/cms/home/douka_dali_headpic_wx?media_id=yyyyyyy&type=png
    ...
    //获取假分数
	//http://doukadali.loc/cms/home/douka_dali_get_score_jia
	...
	//提交个人信息
	//http://doukadali.loc/cms/home/douka_dali_userinfo?realname=小明&mobile=13988887777&address=南京路100号&score=33&percent=90&filestring=图片base64内容
	...
	//提交祝福语
	//http://doukadali.loc/cms/home/douka_dali_get_userinfo_by_game_id?game_id=124
