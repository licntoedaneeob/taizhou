...
class baomingAction extends TAction
{
	...
	//报名申请  http://cdmalasong.loc/baoming/apply/code/abcd5678/order_id/2449
	...
	public function apply_confirm_sub(){
	    ...
	    //$this->set_log_sql($sql);
			...
			if(!empty($invit_data['id'])){
				$msg_body='尊敬的'.$order_info['realname'].'，感谢您报名2017成都国际马拉松赛'.$cat_name.'项目，您的报名信息已经提交，请于8月14日10:00上传体检证明、成绩证书并填写摆渡信息，感谢您的参与！【成都国际马拉松组委会】';
			}
			else{
				$msg_body='尊敬的'.$order_info['realname'].'，感谢您报名2017成都国际马拉松赛'.$cat_name.'项目，您的报名信息已经提交，请耐心等待组委会抽签！抽签结果将于8月14日10:00发布，请及时通过官网首页“状态查询”功能查看是否中签，感谢您的参与！【成都国际马拉松组委会】';
			}
