...
class TagLibLook extends TagLib{
    // 标签定义
     ...
     public function _calendar($attr,$content){     	
        ...
        if($more=='true'){
	       $link='';
        	 ...
        	 $link='<link rel="stylesheet" type="text/css" href="__ROOT__/script/calendar/calendar-blue.css"/>
			<script type="text/javascript" src="__ROOT__/script/calendar/calendar.js"></script>';
        }
        $parseStr=''.$link.'
     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            case 'UBB':
                ...
                break;
            case 'KINDEDITOR':                
                $parseStr='<script type="text/javascript" src="__ROOT__/script/kindeditor/kindeditor.js"></script><script type="text/javascript" src="__ROOT__/script/kindeditor/lang/zh_CN.js"></script><script> var editor; KindEditor.ready(function(K) { editor = K.create(\'#'.$id.'\');});</script><textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" >'.$content.'</textarea>';
                break;
            case 'CKEDITOR':                
                $parseStr   =	'<!-- 编辑器调用开始 --><script type="text/javascript" src="__ROOT__/script/ckeditor/ckeditor.js"></script><textarea id="'.$id.'" name="'.$name.'">'.$content.'</textarea><script type="text/javascript"> var oCKeditor = new CKeditor( "'.$id.'","'.$width.'","'.$height.'" ) ; oFCKeditor.BasePath = "__ROOT__/script/ckeditor/" ; oCKeditor.ReplaceTextarea() ;function resetEditor(){setContents("'.$id.'",document.getElementById("'.$id.'").value)}; function saveEditor(){document.getElementById("'.$id.'").value = getContents("'.$id.'");} function InsertHTML(html){ var oEditor = CKeditorAPI.GetInstance("'.$id.'") ;if (oEditor.EditMode == FCK_EDITMODE_WYSIWYG ){oEditor.InsertHtml(html) ;}else	alert( "CKEditor必须处于WYSIWYG模式!" ) ;}</script> <!-- 编辑器调用结束 -->';
                break;
            default :
