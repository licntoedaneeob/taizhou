...
class joinAction extends TAction
{
    ...
    public function export()
    {
        ...
        $expstr="\t";
        $expenter="\t\n";
        $output .= "行程定制ID编号".$expstr."目的地".$expstr."出发时间"
            .$expstr."旅行天数".$expstr."旅行人数"
            .$expstr."当地出行方式".$expstr."电子邮箱"
            .$expstr."手机号码".$expstr."QQ号码".$expstr."姓名"
            .$expstr."留言"
            .$expstr."来源"
            .$expstr."提交时间"
            .$expenter;
        ...
        if (!empty($toShow['banner'])){
            ...
            do{
                ...
                if ($toShow['banner'][$k]['device']=="1"){
                    ...
                    $output .= $toShow['banner'][$k]['id'].$expstr.$toShow['banner'][$k]['title'].$expstr.$toShow['banner'][$k]['trip_date']
                        .$expstr.$toShow['banner'][$k]['day_num'].$expstr.$toShow['banner'][$k]['person_num']
                        .$expstr.$toShow['banner'][$k]['trip_type'].$expstr.$toShow['banner'][$k]['email']
                        .$expstr.$toShow['banner'][$k]['mobile'].$expstr.$toShow['banner'][$k]['qq'].$expstr.$toShow['banner'][$k]['realname']
                        .$expstr.$summary
                        .$expstr.$device_show
