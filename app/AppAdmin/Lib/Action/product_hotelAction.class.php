 ...
 *
 */
class product_hotelAction extends TAction
{
...
//    }
	...
	{	
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $product_hotelMod = M('product_hotel');
            $sql=" id in (".$in.") ";
            $product_hotelMod->where($sql)->delete();

            $this->success('删除成功', U('product_hotel/listing'));
            exit;
        }
        ...
        $this->ModManager = M('product_hotel');
		...
		///获取列表数据集		
		$rst=$this->GeneralActionForListing('product_hotel', $sqlWhere, $sqlOrder, '', 'M');
		...
		$PageTitle = L('酒店列表');
		$PageMenu = array(
			array( U('product_hotel/create'), L('添加酒店') ),
		);
    ...
    public function create()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            //$rst=$this->Checkproduct_hotelData_Post();

            if (false === $product_hotelMod->create()) {
                $this->error($module->getError());
            }

            if($product_hotelMod->create()) {

                //$rst=$this->Checkproduct_hotelData_Mod($product_hotelMod);
                $product_hotelMod->create_time=time();
                $product_hotelMod->modify_time=time();

                $result =   $product_hotelMod->add();
                if($result) {
                    $this->success('操作成功！', U('product_hotel/create'));
                }else{
                    $this->error('写入错误！');
                }
            }else{
                $this->error($product_hotelMod->getError());
            }
            ...
            $PageTitle = L('添加酒店');
            $PageMenu = array(
                array( U('product_hotel/listing'), L('酒店列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
	...
	public function edit()
	{
		...
		if(isset($_POST['dosubmit'])){
            ...
            //$rst=$this->Checkproduct_hotelData_Post($id);

	        $product_hotelMod = M('product_hotel');

	        if($product_hotelMod->create()) {
	        	
                //$rst=$this->Checkproduct_hotelData_Mod($product_hotelMod,$id);
                $product_hotelMod->modify_time=time();

	            $result =   $product_hotelMod->save();
	            if($result) {
	                $this->success('操作成功！', U('product_hotel/edit', array('id'=>$id)) );
	            }else{
	                $this->error('写入错误！');
	            }
	        }else{
	...
	{
		$module = $UserMod = M('product_hotel');
...
*/
	...
	private function Checkproduct_hotelData_Post($user_id=0){
		///检查 $_POST 提交数据

	}
	

	private function Checkproduct_hotelData_Mod(&$User, $user_id=0){
...
/*酒店图集*/
    ...
    public function listing_product_hotelphoto()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $product_hotelMod = M('product_hotelphoto');
            $sql=" id in (".$in.") ";
            $product_hotelMod->where($sql)->delete();

            $this->success('删除成功', U('product_hotel/listing_product_hotelphoto'));
            exit;
        }
        ...
        $this->ModManager = M('product_hotelphoto');
        $f_order = $this->REQUEST('_f_order', 'id');
        $fields = $this->ModManager->getDbFields();
        //echo "<pre>";print_r($fields);exit;
        if( in_array($f_order, $fields) ){
        ...
        ///获取列表数据集
        $rst=$this->GeneralActionForListing('product_hotelphoto', $sqlWhere, $sqlOrder, '', 'M');
        //echo "<pre>";print_r($rst);exit;
        ...
        $PageTitle = L('酒店图集列表');
        $PageMenu = array(
            array( U('product_hotel/create_product_hotelphoto'), L('添加酒店图集') ),
        );
        $this->setPagething( $PageTitle, $PageMenu, true);
        $this->display();
    }

    public function ajax_change_status_product_hotelphoto()
    {
        $module = $UserMod = M('product_hotelphoto');
        $id 	= intval($_REQUEST['id']);
        //$type 	= isset($_REQUEST['type']) ? trim($_REQUEST['type']) : 'status';
        $status = $type=($type+1)%2;
    ...
    public function create_product_hotelphoto()
    {
        $allclasslist=$this->getAllClassList();
        $this->assign('allclasslist', $allclasslist );
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加酒店图集');
            $PageMenu = array(
                array( U('product_hotel/listing_product_hotelphoto'), L('酒店图集列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_product_hotelphoto()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($product_hotelMod->create()) {
                ...
                $result =   $product_hotelMod->save();
                if($result) {
                    $this->success('操作成功！', U('product_hotel/edit_product_hotelphoto', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
...
/*酒店设计*/
    ...
    public function listing_product_hoteldesign()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $product_hotelMod = M('product_hoteldesign');
            $sql=" id in (".$in.") ";
            $product_hotelMod->where($sql)->delete();

            $this->success('删除成功', U('product_hotel/listing_product_hoteldesign'));
            exit;
        }
        ...
        $this->ModManager = M('product_hoteldesign');
        $f_order = $this->REQUEST('_f_order', 'id');
        $fields = $this->ModManager->getDbFields();
        //echo "<pre>";print_r($fields);exit;
        if( in_array($f_order, $fields) ){
        ...
        ///获取列表数据集
        $rst=$this->GeneralActionForListing('product_hoteldesign', $sqlWhere, $sqlOrder, '', 'M');
        //echo "<pre>";print_r($rst);exit;
        ...
        $PageTitle = L('酒店图集列表');
        $PageMenu = array(
            array( U('product_hotel/create_product_hoteldesign'), L('添加酒店图集') ),
        );
        $this->setPagething( $PageTitle, $PageMenu, true);
        $this->display();
    }

    public function ajax_change_status_product_hoteldesign()
    {
        $module = $UserMod = M('product_hoteldesign');
        $id 	= intval($_REQUEST['id']);
        //$type 	= isset($_REQUEST['type']) ? trim($_REQUEST['type']) : 'status';
        $status = $type=($type+1)%2;
    ...
    public function create_product_hoteldesign()
    {
        $allclasslist=$this->getAllClassList();
        $this->assign('allclasslist', $allclasslist );
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加酒店图集');
            $PageMenu = array(
                array( U('product_hotel/listing_product_hoteldesign'), L('酒店图集列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_product_hoteldesign()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($product_hotelMod->create()) {
                ...
                $result =   $product_hotelMod->save();
                if($result) {
                    $this->success('操作成功！', U('product_hotel/edit_product_hoteldesign', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
