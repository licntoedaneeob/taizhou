 ...
 *
 */
class inchengdu_class extends TAction
{
...
//    }
	...
	{	echo "b";exit;
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $inchengdu_classMod = M('inchengdu_class');
            $sql=" id in (".$in.") ";
            $inchengdu_classMod->where($sql)->delete();

            $this->success('删除成功', U('inchengdu_class/listing'));
            exit;
        }
        ...
        $this->ModManager = M('inchengdu_class');
		...
		///获取列表数据集		
		$rst=$this->GeneralActionForListing('inchengdu_class', $sqlWhere, $sqlOrder, '', 'M');
		...
		$PageTitle = L('在成都列表');
		$PageMenu = array(
			array( U('inchengdu_class/create'), L('添加在成都') ),
		);
    ...
    public function create()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            //$rst=$this->Checkinchengdu_classData_Post();

            if (false === $inchengdu_classMod->create()) {
                $this->error($module->getError());
            }

            if($inchengdu_classMod->create()) {

                //$rst=$this->Checkinchengdu_classData_Mod($inchengdu_classMod);
                $inchengdu_classMod->create_time=time();
                $inchengdu_classMod->modify_time=time();

                $result =   $inchengdu_classMod->add();
                if($result) {
                    $this->success('操作成功！', U('inchengdu_class/create'));
                }else{
                    $this->error('写入错误！');
                }
            }else{
                $this->error($inchengdu_classMod->getError());
            }
            ...
            $PageTitle = L('添加在成都');
            $PageMenu = array(
                array( U('inchengdu_class/listing'), L('在成都列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
	...
	public function edit()
	{
		...
		if(isset($_POST['dosubmit'])){
            ...
            //$rst=$this->Checkinchengdu_classData_Post($id);

	        $inchengdu_classMod = M('inchengdu_class');

	        if($inchengdu_classMod->create()) {
	        	
                //$rst=$this->Checkinchengdu_classData_Mod($inchengdu_classMod,$id);
                $inchengdu_classMod->modify_time=time();

	            $result =   $inchengdu_classMod->save();
	            if($result) {
	                $this->success('操作成功！', U('inchengdu_class/edit', array('id'=>$id)) );
	            }else{
	                $this->error('写入错误！');
	            }
	        }else{
	        ...
	        $inchengdu_classMod = M('inchengdu_class');
		    // 读取数据
		    $data =   $inchengdu_classMod->find($id);
		    if($data) {
	...
	{
		$module = $UserMod = M('inchengdu_class');
...
*/
	...
	private function Checkinchengdu_classData_Post($user_id=0){
		///检查 $_POST 提交数据

	}
	

	private function Checkinchengdu_classData_Mod(&$User, $user_id=0){
...
/*在成都图集*/
    ...
    public function listing_inchengdu_classphoto()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $inchengdu_classMod = M('inchengdu_classphoto');
            $sql=" id in (".$in.") ";
            $inchengdu_classMod->where($sql)->delete();

            $this->success('删除成功', U('inchengdu_class/listing_inchengdu_classphoto'));
            exit;
        }
        ...
        $this->ModManager = M('inchengdu_classphoto');
        $f_order = $this->REQUEST('_f_order', 'id');
        $fields = $this->ModManager->getDbFields();
        //echo "<pre>";print_r($fields);exit;
        if( in_array($f_order, $fields) ){
        ...
        ///获取列表数据集
        $rst=$this->GeneralActionForListing('inchengdu_classphoto', $sqlWhere, $sqlOrder, '', 'M');
        //echo "<pre>";print_r($rst);exit;
        ...
        $PageTitle = L('在成都图集列表');
        $PageMenu = array(
            array( U('inchengdu_class/create_inchengdu_classphoto'), L('添加在成都图集') ),
        );
        $this->setPagething( $PageTitle, $PageMenu, true);
        $this->display();
    }

    public function ajax_change_status_inchengdu_classphoto()
    {
        $module = $UserMod = M('inchengdu_classphoto');
        $id 	= intval($_REQUEST['id']);
        //$type 	= isset($_REQUEST['type']) ? trim($_REQUEST['type']) : 'status';
        $status = $type=($type+1)%2;
    ...
    public function create_inchengdu_classphoto()
    {
        $allclasslist=$this->getAllClassList();
        $this->assign('allclasslist', $allclasslist );
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加在成都图集');
            $PageMenu = array(
                array( U('inchengdu_class/listing_inchengdu_classphoto'), L('在成都图集列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_inchengdu_classphoto()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($inchengdu_classMod->create()) {
                ...
                $result =   $inchengdu_classMod->save();
                if($result) {
                    $this->success('操作成功！', U('inchengdu_class/edit_inchengdu_classphoto', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
...
/*在成都设计*/
    ...
    public function listing_inchengdu_classdesign()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $inchengdu_classMod = M('inchengdu_classdesign');
            $sql=" id in (".$in.") ";
            $inchengdu_classMod->where($sql)->delete();

            $this->success('删除成功', U('inchengdu_class/listing_inchengdu_classdesign'));
            exit;
        }
        ...
        $this->ModManager = M('inchengdu_classdesign');
        $f_order = $this->REQUEST('_f_order', 'id');
        $fields = $this->ModManager->getDbFields();
        //echo "<pre>";print_r($fields);exit;
        if( in_array($f_order, $fields) ){
        ...
        ///获取列表数据集
        $rst=$this->GeneralActionForListing('inchengdu_classdesign', $sqlWhere, $sqlOrder, '', 'M');
        //echo "<pre>";print_r($rst);exit;
        ...
        $PageTitle = L('在成都图集列表');
        $PageMenu = array(
            array( U('inchengdu_class/create_inchengdu_classdesign'), L('添加在成都图集') ),
        );
        $this->setPagething( $PageTitle, $PageMenu, true);
        $this->display();
    }

    public function ajax_change_status_inchengdu_classdesign()
    {
        $module = $UserMod = M('inchengdu_classdesign');
        $id 	= intval($_REQUEST['id']);
        //$type 	= isset($_REQUEST['type']) ? trim($_REQUEST['type']) : 'status';
        $status = $type=($type+1)%2;
    ...
    public function create_inchengdu_classdesign()
    {
        $allclasslist=$this->getAllClassList();
        $this->assign('allclasslist', $allclasslist );
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加在成都图集');
            $PageMenu = array(
                array( U('inchengdu_class/listing_inchengdu_classdesign'), L('在成都图集列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_inchengdu_classdesign()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($inchengdu_classMod->create()) {
                ...
                $result =   $inchengdu_classMod->save();
                if($result) {
                    $this->success('操作成功！', U('inchengdu_class/edit_inchengdu_classdesign', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
