 ...
 *
 */
class photoAction extends TAction
{
...
//    }
    ...
    public function listing_classfather()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            //删除自身数据
            $NewsMod = M('photo_class');
            $sql=" id in (".$in.") ";
            $NewsMod->where($sql)->delete();

            $this->success('删除成功', U('photo/listing_classfather'));
            exit;
        }
        ...
        ///获取列表数据集
        $rst=$this->GeneralActionForListing('photo_class', $sqlWhere, $sqlOrder, '', 'M');
        //echo "<pre>";print_r($rst);exit;

        $PageTitle = L('一级分类列表');
        $PageMenu = array(
            array( U('photo/create_classfather'), L('添加一级分类') ),
        );
    ...
    public function create_classfather()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加一级分类');
            $PageMenu = array(
                array( U('photo/listing_classfather'), L('一级分类列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_classfather()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($NewsMod->create()) {
                ...
                $result =   $NewsMod->save();
                if($result) {
                    $this->success('操作成功！', U('photo/edit_classfather', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
    ...
    public function listing_class()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            $this->success('删除成功', U('photo/listing_class'));
            exit;
        }
        ...
        $PageTitle = L('二级分类列表');
        $PageMenu = array(
            array( U('photo/create_class'), L('添加二级分类') ),
        );
        $this->setPagething( $PageTitle, $PageMenu, true);
        $this->display();
    }
    ...
    public function create_class()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加二级分类');
            $PageMenu = array(
                array( U('photo/listing_class'), L('二级分类列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_class()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($NewsMod->create()) {
                ...
                $result =   $NewsMod->save();
                if($result) {
                    $this->success('操作成功！', U('photo/edit_class', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
    ...
    public function listing_photo()
    {
        ...
        if(isset($_POST['dosubmit']) && $_POST['dosubmit']=='删除'){
            ...
            $this->success('删除成功', U('photo/listing_photo'));
            exit;
        }
        ...
        ///获取列表数据集
        $rst=$this->GeneralActionForListing('photo', $sqlWhere, $sqlOrder, '', 'M');
        //echo "<pre>";print_r($rst);exit;
        ...
        $PageTitle = L('精彩照片列表');
        $PageMenu = array(
            array( U('photo/create_photo'), L('添加精彩照片') ),
        );
        $this->setPagething( $PageTitle, $PageMenu, true);
        $this->display();
    }
    ...
    public function create_photo()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            $PageTitle = L('添加精彩照片');
            $PageMenu = array(
                array( U('photo/listing_photo'), L('精彩照片列表') ),
            );
            $this->setPagething( $PageTitle, $PageMenu, true);
            $this->display();
        }
    ...
    public function edit_photo()
    {
        ...
        if(isset($_POST['dosubmit'])){
            ...
            if($NewsMod->create()) {
                ...
                $result =   $NewsMod->save();
                if($result) {
                    $this->success('操作成功！', U('photo/edit_photo', array('id'=>$id)) );
                }else{
                    $this->error('写入错误！');
                }
            }else{
